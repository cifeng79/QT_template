...
void myThread1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef int (myThread1::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myThread1::download)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject myThread1::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_myThread1.data,
      qt_meta_data_myThread1,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *myThread1::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_myThread1.stringdata0))
        return static_cast<void*>(const_cast< myThread1*>(this));
...
// SIGNAL 0
int myThread1::download(int _t1)
{
    int _t0 = int();
